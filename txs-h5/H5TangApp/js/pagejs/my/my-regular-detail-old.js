define(["require", "exports", '../api/user', '../api/product'], function (require, exports, user_1, product_1) {
    ...
    var MyRegularDetailPage = (function () {
        ...
        MyRegularDetailPage.prototype.getUserInfo = function () {
            var topDom = this;
            user_1.User.getUserInfo({}, function (data) {
        ...
        MyRegularDetailPage.prototype.getProductBidDetail = function (account) {
            var topDom = this;
            product_1.Product.getProductBidItem({
                ...
                if (data.result) {
                    ...
                    product_1.Product.getProductItem({ productid: product_2.productid }, function (data) {
                        if (data.result) {
                    ...
                    $("#productDetail").click(function () {
                        window.location.href = "/html/product/regular-product-detail.html?id=" + product_2.productid + "&bid=" + topDom.BidID;
                    });
                    if (product_2.status == 8) {
                    ...
                    else if (!product_2.cantransfer && product_2.status != 6 && product_2.status != 4 && product_2.status != 3 && product_2.status != 5) {
